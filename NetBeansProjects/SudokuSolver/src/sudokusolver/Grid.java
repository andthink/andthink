...
public class Grid implements Cloneable {
	...
	/*
	 * Finds an empty cell. @return the location of an empty cell or -1 if there
	 * are no empty cells. Values must be in the range [-1, 80].
	 */
	 ...
	 * false is returned. @param loc the location of the target cell. Values
	 * must be in the range [0, 80]. @param num the number to set in the cell.
	 * Values must be in the range [1, 9]. @return true if the set was
	 * successful.
	 */
	...
	/*
	 * Removes the number in a cell. @param loc the location of the target cell.
